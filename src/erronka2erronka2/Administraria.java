    ...
    public List<String> verBezeroak() throws SQLException {
        ...
        while (rs.next()) {
            lista.add(
                ...
                " | Apellidos: " + rs.getString("abizenak") +
                " | NAN: " + rs.getString("Nan") +
                " | Dirección: " + rs.getString("helbidea") +
                " | Email: " + rs.getString("email") +
                " | Usuario: " + rs.getString("erabiltzailea") +
    ...
    public List<String> verLangileak() throws SQLException {
        ...
        while (rs.next()) {
            lista.add(
                ...
                " | Nombre: " + rs.getString("izena") +
                " | Apellidos: " + rs.getString("abizenak") +
                " | País: " + rs.getString("herrialdea") +
                " | Email: " + rs.getString("email") +
                " | Código Postal: " + rs.getInt("posta_kodea") +
                " | Usuario: " + rs.getString("erabiltzailea") +
                " | Contraseña: " + rs.getString("pasahitza") +
